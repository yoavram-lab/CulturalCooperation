...
In their model, cooperative behavior can evolve if~\citep[eq.~3.2]{Eshel1982}
...
Instead of searching for evolutionarily stable strategies, we focus on \emph{evolutionary genetic stblility (EGS)}~\citep{lessard1990evolutionary}.
EGS occurs when the frequencies of types (genotypes, phenotypes etc.) remains stable.
...
We assume coexistence of both phenotypes (cooperators and defectors) and that the frequency of each phenotype stays stable over time.
...
\begin{figure}[pt]
  ...
  \caption{\textbf{Modifier model illustration.} Starting from stable equilibrium with coexistence of both phenotypes (red and green) and the resident modifier allele with interaction-transmission association $\alpha_1$.
  An invading modifier allele that modifies the interaction-transmission association to $\alpha_2$ invades the population.
  }
...
\begin{figure}[p]
  \centering       
    \includegraphics[width=0.9\textwidth]{../PRSB_figures/fig_3.pdf}
...
\begin{figure}[p]
  \centering       
	\includegraphics[width=0.9\textwidth]{../PRSB_figures/fig_4.pdf}
...
\begin{figure}[h]
  \centering       
    ...
    \textbf{(a)} The system has an unstable equilibrium and therefore all the curves are moving away from it.
    \textbf{(b)} The system has a stable equilibrium and therefore all the curves moves towards it. 
