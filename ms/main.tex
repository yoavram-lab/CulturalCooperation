...
These initiators interact (i) in a prisoner's dilemma game (\autoref{fig:illustration}d) with a random neighbour (i.e. individual in a neighbouring site); and (ii) in horizontal cultural transmission (\autoref{fig:illustration}c) with a random neighbour (with replacement, i.e. possibly the same neighbour).
