...
Our results demonstrate that cultural transmission can enhance the evolution of cooperation even when genetic transmission cannot, partly because it can facilitate the generation of assortment \citep{Fletcher2009assortment}, and partly because it can diminish the effect of natural selection \citep{ram2018evolution}.
...
and the Morrison Institute for Population and Resources Studies at Stanford University (MWF).
...
\begin{figure}[p]
  \centering       
    ...
    ~
    \includegraphics[width=0.45\textwidth]{coexistence_without_oblique.eps}
    \caption{\textbf{Evolution of cooperation under vertical and horizontal cultural transmission (v=1).} 
    Figures \textbf{(a)-(c)} shows the parameter ranges for global fixation of cooperation (green), global fixation of defection (red), fixation of either cooperation or defection depending on the initial conditions, i.e. unstable polymorphism (blue), and stable polymorphism of cooperation and defection (yellow).
    In figures \textbf{(a)-(c)} the horizontal bias ($T_A-T_B$) is on the x-axis.
    ...
    Here in figures \textbf{(a)-(c)}, $b=1.3$, $T_A=0.4$, (\textbf{a})~$\alpha = 0$,(\textbf{b})~$\alpha = 0.7$, (\textbf{c})~$c = 0.35$.
    In figure \textbf{(d)} shows stable and unstable polymorphism of cooperation and defection.
...
\begin{figure}[p]
  \centering
   % \includegraphics[scale=0.4]{coexistence_without_oblique.eps}
    \includegraphics[scale=0.6]{coexistence_with_oblique.eps}
