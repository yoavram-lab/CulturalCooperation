...
\begin{figure}[h]
  ...
  \textbf{(b)} Individuals socially interact in pairs in a prisoners' dilemma game. Horizontal cultural transmission occurs with a random individual from the population, with probability $1-\alpha$, or with the social partner, with probability $\alpha$, where $\alpha$ is the interaction-transmission association parameter.
  \textbf{(c)} The probability of successful horizontal  cultural transmission of phenotypes $A$ and $B$ is $T_A$ and $T_B$ respectively.
  \textbf{(d)} Offspring inherit their parent phenotype with probability $v$, or the phenotype of a random non-parental adult with probability $1-v$.
    }
...
\begin{figure}[p]
  \centering       
	...
	In panel (c), interaction-transmission association $\alpha$ is on the y-axis and the interaction-transmission association thresholds $a_1$ and $a_2$ (Eqs.~\ref{eq:boundries_assortative_meeting_general_case}) are the solid and dashed lines, respectively.
...
\begin{figure}[p]
  ...
  Black curves represent the cost thresholds for the evolution of cooperation in a well-mixed population with interaction-transmission association, where $\alpha=1/8$ in inequality~\ref{eq:equal_transmission} for  panel~(a) and in inequality~\ref{eq:cost_thresholds_v_threshold} for~(b).
...
\begin{figure}[h]
  ...
  The black curves represent the cost thresholds for the evolution of cooperation in a well-mixed population with interaction-transmission association, where $\alpha=1/8$ in inequality~\ref{eq:equal_transmission} for panel~(a) and in Eqs.~\ref{eq:cost_thresholds_v_threshold} for panel (b).
  The population evolves on a 100-by-100 grid.
