...
\\
  ...
  &+ \tilde{p}_1(\tilde{p}_1 + \tilde{p}_3)(1-\alpha_1)(\tilde{p}_2 + \tilde{p}_4)T_B 
\\
	% p3
...
\\
  ...
  &+ \tilde{p}_3(\tilde{p}_1 + \tilde{p}_3)(1-\alpha_2)(\tilde{p}_2 + \tilde{p}_4)T_B \;,
  \end{aligned}
\end{equation}
...
\mathbf{L}^*_{ex} = \frac{1}{\bar{w}^*} \begin{bmatrix}
	 \frac{\partial \tilde{p}_3'}{\partial \tilde{p}_3}(\vec{\tilde{p}}^*) &
	 \frac{\partial \tilde{p}_3'}{\partial \tilde{p}_4}(\vec{\tilde{p}}^*) \\
	 \frac{\partial \tilde{p}_4'}{\partial \tilde{p}_3}(\vec{\tilde{p}}^*) &
	 \frac{\partial \tilde{p}_4'}{\partial \tilde{p}_4} (\vec{\tilde{p}}^*)
\end{bmatrix} \;.
\end{equation}
...
\begin{equation} \label{eq:partial_derivatives}
  \begin{aligned}
  &\frac{\partial\tilde{p}_3'}{\partial \tilde{p}_3}(\vec{\tilde{p}}^*) = b(\tilde{p}^*-(1-\alpha_2)T_B(\tilde{p}^*-\tilde{p}^{*2}))+(1-c)(1+\tilde{p}^*T_B-T_B)\\
  &\frac{\partial\tilde{p}_3'}{\partial \tilde{p}_4}(\vec{\tilde{p}}^*) = bT_A\tilde{p}^*(\tilde{p}^*+\alpha_2(1-\tilde{p}^*))+\tilde{p}^*T_A\\
  &\frac{\partial\tilde{p}_4'}{\partial \tilde{p}_3}(\vec{\tilde{p}}^*) = T_B(1-\tilde{p}^*)-cT_B(1-\tilde{p}^*)(\alpha_2+(1-\alpha_2)(1-\tilde{p}^*))\\
  &\frac{\partial\tilde{p}_4'}{\partial \tilde{p}_4}(\vec{\tilde{p}}^*) = 1-\tilde{p}^*T_A+ b\tilde{p}^*(1-\alpha_2T_A(1-\tilde{p}^*)-T_A\tilde{p}^*)\\
  \end{aligned}
\end{equation}
