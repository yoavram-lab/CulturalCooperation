...
Therefore, if a modifier allele that increases social association invades the population, the population mean fitness will increase. But can such a modifier allele invade the population?
We assume that social association is determined by a genetically transmitted locus with alleles $m$ and $M$, which induce association probabilities $\alpha_1$ and $\alpha_2$, respectively.

We define the frequencies of the pheno-genotypes $Am$, $Bm$, $AM$, and $BM$ as $\hat{p}_1$, $\hat{p}_2$, $\hat{p}_3$, and $\hat{p}_4$, respectively. 
Then the following recursion system defines the frequencies of the pheno-genotypes in the next generation,
\begin{equation} \label{eq:next_gen_p_1}
  \begin{aligned}
	% p1
  \bar{w}\tilde{p}_1' & = \tilde{p}_1(\tilde{p}_1+\hat{p_3})(1+b-c)(1 - (1-\alpha_1)(\tilde{p}_2 + \tilde{p}_4)T_B) \\
  &+ \tilde{p}_1(\tilde{p}_2 + \tilde{p}_4)(1-c)(1-\alpha_1T_B(\hat{p_1}+\tilde{p}_3) - T_B(\tilde{p}_2+\tilde{p}_4)) \\
  &+ \tilde{p}_2(\tilde{p}_1 + \tilde{p}_3)(1+b)T_A(\tilde{p}_1 + \tilde{p}_3 + \alpha_1(\tilde{p}_2 + \hat{p_4})) \\
  &+ \tilde{p}_2(\tilde{p}_2 + \tilde{p}_4)(\tilde{p}_1 + \tilde{p}_3)(1-\alpha_1)T_A 
\\
	% p2
  \bar{w}\tilde{p}_2' & = \tilde{p}_2(\tilde{p}_2+\hat{p_4})(1 - (1-\alpha_1)(\tilde{p}_1 + \tilde{p}_3)T_A) \\
  &+ \tilde{p}_2(\tilde{p}_1 + \tilde{p}_3)(1+b)(1-\alpha_1T_A(\tilde{p}_2 + \tilde{p}_4)-T_A(\tilde{p}_1 + \tilde{p}_3))\\
  &+ \tilde{p}_1(\tilde{p}_2 + \tilde{p}_4)(1-c)(\alpha_1T_B + (1-\alpha_1)(\tilde{p}_2+\tilde{p}_4)T_B) \\
  &+ \tilde{p}_1(\tilde{p}_1 + \tilde{p}_3)(1-\alpha_1)(\tilde{p}_2+\tilde{p}_4)T_B 
\\
	% p3
  \bar{w}\tilde{p}_3' & = \tilde{p}_3(\tilde{p}_1+\hat{p_3})(1+b-c)(1 - (1-\alpha_2)(\tilde{p}_2 + \tilde{p}_4)T_B) \\
  &+ \tilde{p}_3(\tilde{p}_2 + \tilde{p}_4)(1-c)(1-\alpha_2T_B(\hat{p_1}+\tilde{p}_3) - T_B(\tilde{p}_2+\tilde{p}_4)) \\
  &+ \tilde{p}_4(\tilde{p}_1 + \tilde{p}_3)(1+b)T_A(\tilde{p}_1 + \tilde{p}_3 + \alpha_2(\tilde{p}_2 + \hat{p_4})) \\
  &+ \tilde{p}_4(\tilde{p}_2 + \tilde{p}_4)(\tilde{p}_1 + \tilde{p}_3)(1-\alpha_2)T_A 
\\
	% p4
  \bar{w}\tilde{p}_4' & = \tilde{p}_4(\tilde{p}_2+\hat{p_4})(1 - (1-\alpha_2)(\tilde{p}_1 + \tilde{p}_3)T_A) \\
  ...
  \end{aligned}
\end{equation}
where $\bar{w} = 1 + (b-c)\cdot(\tilde{p}_1 + \tilde{p}_3)$ is the population mean fitness.

Denote this system by $\bar{w} \vec{\tilde{p}} = f(\vec{\tilde{p}})$, where $\vec{\tilde{p}} = (\tilde{p}_1,\tilde{p}_2,\tilde{p}_3,\tilde{p}_4)$.
We are interested in the invasion of allele $M$ to a population at equilibrium with allele $m$, that is, with equilibrium frequencies $\vec{\tilde{p}}^*=(\tilde{p}^*, 1-\tilde{p}^*, 0, 0)$, with $\tilde{p}^*$ defined in
\autoref{eq:vert_hori_equilibrium}.
The success of the invasion of allele $M$ is determined by the external stability matrix $\mathbf{L}^*_{ex}$~\citep{Liberman1988}, which is derived from \autoref{eq:next_gen_p_1} as
\begin{equation}
...
\end{bmatrix} \;.
\end{equation}
If the leading eigenvalue of $\mathbf{L}^*_{ex}$ is less than 1, then the equilibrium $\vec{\tilde{p}}$ is locally stable and allele $M$ cannot invade the population of allele $m$.
