...
We assume that the modifier locus has two alleles, $M$ and $m$, which induce social associations $\alpha_1$ and $\alpha_2$, respectively.
...
The full analysis is given in Appendix~\ref{sec:appendixD}, and the following result summarizes the outcomes of such invasions.
\\
...
\begin{figure}[p]
  ...
  Figures \textbf{(a)} and \textbf{(b)} describes the expected frequency of cooperators in a structured population after 10,000 generations is shown (red for 0\%, green for 100\%) as function of both the cost of cooperation ($c$) on the y-axis, and the symmetric horizontal transmission rate ($T=T_A=T_B$) on the x-axis of the left panel \textbf{(a)}, or the transmission bias $T_A-T_B$ on the x-axis of the right panel \textbf{(b)}.
  ...
  Figure \textbf{(b)} emphasizes an area in which neither phenotype is fixed throughout the simulation, maintaining stochastic coexistence. 
...
%    Figure \textbf{(a)} emphasizes the coexistence shown in \autoref{fig:spatial}b in a structured finite population. 
