...
\begin{figure}[h]
  \centering
   ...
   \caption{
    \textbf{Coexistence of both phenotypes in spatial model.}
    ...
    The frequency of cooperators oscillate around the initial frequency. Here, population size is 10,000 (100-by-100 grid), benefit of cooperation, $b=1.3$, perfect vertical transmission $v=1$,
