...
We tested the applicability of our analytic results to a complex spatial stochastic model (\autoref{fig:spatial}). Indeed, our derived condition provide a good approximation to simulation results, demonstrating that association between cooperation and transmission can arise in a structured population simply because the choice of individuals for social interactions is small.
