...
\begin{figure}[p]
  \centering       
    ...
    In panels (a) and (b), the cost of cooperation $c$ is on the y-axis and the cost thresholds $\gamma_1$ and $\gamma_2$ (\autoref{eq:cost_thresholds_v_threshold}) are the solid and dashed lines, respectively. 
	In panel (c), social association $\alpha$ is on the y-axis and the social association thresholds $a_1$ and $a_2$ (\autoref{eq:boundries_assortative_meeting_general_case}) are the solid and dashed lines, respectively.
    ...
    Markers show the three equilibria.
  	}
