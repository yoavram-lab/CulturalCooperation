...
\autoref{fig:equilibria_v1}d shows the mapping $\hat{p} \to \hat{p}'-\hat{p}$.
...
But can this population-level advantage lead to the evolution of social association? 
...
carried out simulations with prisoner's dilemma payoffs but without horizontal transmission or social association ($\alpha=0$).
