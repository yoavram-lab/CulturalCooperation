...
\begin{figure}[h]
  \centering
   ...
   \caption{
    ...
    The dyanmics of the frequancy of cooperators (green) and the frequency of defactors in the spatial model. 
    Both groups has the same initial frequency (0.5) and there are no fixation of one of the groups through the simulation.
    The frequency of cooperators oscillate around the initial frequency. Here, population size is 10,000 (100-by-100 grid), selection operates globally, benefit of cooperation, $b=1.3$, perfect vertical transmission $v=1$,
    horizontal transmission of cooperators $T_A = 0.4$, horizontal transmission of defactors $T_B = 0.435$ and cost $c=0.02$.
    }
