...
\end{equation} 
We derive $\bar{w}$ by $alpha$
\begin{equation} \label{eq:mean_fitness_stable_coexistence_derivative}
  \begin{aligned}
  \frac{d\bar{w}}{d\alpha} & = (b-c)\cdot \frac{-b^2T_A (1-\alpha) (T_A-T_B) + b(T_A-T_B)(c(1-T_B) - b \alpha T_A - (T_A-T_B))}{b^2 (1-\alpha)^2 (T_A-T_B)^2} \\
  &= (b-c)\cdot\frac{b^2T_A(T_B-T_A)-bc(1-T_B)(T_B-T_A) - b(T_B-T_A)^2}{b^2 (1-\alpha)^2 (T_A-T_B)^2}
  \end{aligned}
\end{equation} 
Since $b>c$ and the denominator is always positive the derivative of mean fitness by alpha will be positive if the numerator is positive for every alpha.
