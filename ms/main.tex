...
Corollary~\autoref{corollary:Intermediate_association} is true for the general but with new boundaries coefficients $\hat{a}_1$, $\hat{a}_2$. \autoref{fig:result3}c and \autoref{fig:result3}d illustrate this result.
