...
%TODO Equation 4 does not give $\hat{p}$---MWF
...
%TODO fix for increasing from rarity, only using a2
...
At each generation, each individual is chosen to "initiate" interactions with probability 1/2.\ %TODO "with probability 1/2" not clear - MWF
...
%TODO How are A, B initialized on the grid? – MWF
