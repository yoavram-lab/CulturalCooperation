...
%This condition can also be formulated as a condition on the cost of cooperation $c$: cooperation will take over the population if
%\begin{equation} \label{eq:unequal_transmission}
%c < \frac{
%	b \big[\alpha T_A + (1-\alpha)\tilde{p}(T_A - T_B)\big] + (T_A - T_B)
%	}{
%	1-T_B
%	}.
%\end{equation}
%
%Importantly, the condition for cooperation to increase from rarity is (set $\tilde{p}=0$ in \autoref{eq:unequal_transmission})
