...
These eigenvalues are the root of the characteristic polynomial $\lambda^2 -\lambda \frac{(X+Q)}{\bar{w}} + \frac{XQ - YZ}{\bar{w}^2}$; the leading eigenvalue $\lambda_1$ is the largest of them,
\begin{equation} \label{eq:eigenvalues}
  \lambda_1 = \frac{X+Q + \sqrt{(X+Q)^2 - 4(XQ-YZ)}}{2\bar{w}} \;.
\end{equation}
...
\begin{figure}[p]
  \centering
   \includegraphics[scale=0.75]{{Ta=0.4_Tb=0.3-0.5_b=1.3_globalSelection_withSmallBox_a}.pdf}~\\
