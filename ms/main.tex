...
%TODO Is the last sentence requried ? Should we mention here we already saw result 1 - when $T_A > T_B$ we will have global fixation of cooperation 
...
%TODO - do we need the command above ? DC
...
\begin{figure}[h]
  ...
  \label{fig:spatial}
  %TODO: What is the T in panel A ? DC
  %TODO: Discuss with Yoav the fact that it is not rally alpha = 1/8 but alpha approx. 1/8 - DC
  %TODO: Ohad choose to show the figures with local selection - DC
